...
const DrawerNavigation = () => {
  return(
    ...
    >
      ...
      <Drawer.Screen name={Constants.screen.AllJobsScreen} component={AllJobsScreen}/>
      <Drawer.Screen name={Constants.screen.Payment_Screen} component={Payment_Screen}/>
      <Drawer.Screen  name={Constants.screen.Payment_Card} component={Payment_Card}/>
    </Drawer.Navigator>
  )
}
