...
const UnAuthorizedStack = () => {
  return (
    ...
    >
      ...
      <Screen
        name={Constants.screen.ForgotPassScreen}
        component={ForgotPassScreen}
      />
      <Screen
        name={Constants.screen.RegisterScreen}
        component={RegisterScreen}
      />
      <Screen
        name={Constants.screen.EmployerDrawerStack}
        component={EmployerDrawerStack}
      />
      <Screen
        name={Constants.screen.DrawerNavigation}
