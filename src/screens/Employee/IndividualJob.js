  ...
  async function saveJob() {
    ...
    try {
      ...
      if (response.isAxiosError == true) {
        setErrorMessage(
          response.response.data.error.messages.map((val) => val + "\n")
        );
        setLoader(false);
        setErrorModal(true);
    ...
    <>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View
            style={{ position: "absolute", width: "100%", padding: 9, flex: 1 }}
          >
            <View
            ...
            <View style={styles.JobContainer}>
              <Image
                source={
                  jobDetails.image_urls
                    ? { uri: jobDetails.image_urls["3x"] }
              ...
              >
                ...
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  <View style={{ flexDirection: "row" }}>
                    <Text style={{ marginRight: 2, color: colors.gray }}>
                      No of Posts:
                    </Text>
              ...
              <Divider
                style={{ marginLeft: 15, marginTop: 15, width: "90%" }}
              />

              <IconText
                style={{ alignItems: "center" }}
                text="Designa"
                textStyle={{ color: "black", fontWeight: "bold", fontSize: 14 }}
              >
                <MaterialIcons
                  name="person"
                  size={25}
              ...
              <Text
                style={{ marginLeft: 35, marginTop: 2, color: colors.gray }}
              >
                {jobDetails.title}
              </Text>
              ...
              <View style={{ flexDirection: "row", marginTop: 15 }}>
                ...
                <Button
                  ...
                  style={{
                    ...styles.saveButton,
                    backgroundColor:
                      jobDetails.is_saved == "1" ? colors.gray : colors.yellow,
                  }}
