  ...
  const pdf_ApiCall = async (pdf) => {
    ...
    try {
      const rawResponse = await axios.post(
        "https://admin2.sadpoetrylive.com/api/upload-files",
        form,
        {
          headers: {
    ...
    if (Platform.OS === "ios") {
      ...
      try {
        ...
        if (granted === PermissionsAndroid.RESULTS.GRANTED) {
          ...
          const res = await RNFS.moveFile(
            `${RNFS.ExternalStorageDirectoryPath}/Android/data/com.searchwork/files/${image}`,
          ...
          <View style={styles.resumeContainer}>
            <View style={styles.rowContainer}>
              <View style={styles.leftColumn}>
                ...
                >
                  <Logo
                    style={[styles.logo, { transform: [{ rotate: "-25deg" }] }]}
                  />
                </View>
                ...
                <IconText
                  text={`${userProfile?.address}, ${userProfile?.city}, ${userProfile?.state}, ${userProfile?.zipcode}`}
                >
                  <Ionicons
              ...
              <View style={styles.rightColumn}>
                ...
                >
                  ...
                  <Image
                    source={require("../../../assets/resumeChip.png")}
                    resizeMode="contain"
                ...
                {userProfile?.objective != null && (
                  <>
                    ...
                    <Text
                      style={{ fontSize: 13, marginRight: 4, marginTop: 7 }}
                    >
