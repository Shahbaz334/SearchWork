  ...
  return (
    <>
      ...
      >
        ...
        >
          <HeaderImage
            style={{ height: Dimensions.get("window").height * 0.21 }}
          />
            ...
            >
              {dashboardSlideImages.map((val, index) => (
                <View key={index} style={styles.slide}>
                  <Image source={val.image} style={styles.slideImage} />
                </View>
              ))}
            </Swiper>
          </View>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    if (val.subcategories != null) {
                      navigation.navigate(Constants.screen.JobCategoryList, {
                        val,
                      });
                    } else {
          ...
          <View style={{ marginHorizontal: 15 }}>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate(Constants.screen.AllJobsScreen)
                }
                ...
                {recentJobs.map((val, index) => (
                  <View key={index} style={{ alignItems: "center" }}>
                    <JobCard
                      ...
                      imageSource={
                        val.image_urls
                          ? { uri: val.image_urls["3x"] }
                          : require("../../../assets/logo.png")
                      }
                      jobDescription={val.description}
                      duration={
                        val.duration == "full_time" ? "Full-time" : "Part-Time"
                      }
