    ...
    return (
      <View style={styles.jobContainer}>
        ...
        <View style={{ marginLeft: 8, flex: 1 }}>
          <Text ellipsizeMode="tail" numberOfLines={1} style={styles.jobTitle}>
            {item.job["title"]}
          </Text>
    ...
    <>
      ...
      {savedList.length > 0 ? (
        <View style={{ flex: 1 }}>
          ...
          >
            <HeaderImage
              style={{ height: Dimensions.get("window").height * 0.22 }}
            />
            ...
            <View style={{ position: "absolute", width: "100%", padding: 9 }}>
              ...
              <SearchField value={searchJob} onChangeText={setSearchJob} />
            </View>
