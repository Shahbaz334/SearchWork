  ...
  return (
    <>
      ...
      >
        ...
        <HeaderImage
          style={{ height: Dimensions.get("window").height * 0.29 }}
        />
        ...
        <HeaderRowContainer>
          ...
          <View
            style={{ alignItems: "center", width: 190, overflow: "hidden" }}
          >
            <ProfilePicture
              ...
              imageSource={
                user?.image_urls != undefined && user?.image_urls["3x"]
              }
        ...
        <View style={styles.infoContainer}>
          ...
          <Heading
            title={LocalStrings.ad_Information}
            style={{ marginTop: 16 }}
          />
