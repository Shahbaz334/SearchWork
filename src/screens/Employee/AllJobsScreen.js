...
import { StyleSheet, Text, View, ImageBackground, Image, TouchableOpacity, StatusBar, Dimensions, FlatList } from 'react-native';
  ...
  const viewJob = async (jobId) => {
    ...
    try {
      ...
      if (apiResult.isAxiosError == true) {
        console.log('View Job Method:',apiResult.response.data.error.messages.map(val => val+'\n'))
        setLoader(false)
      }
      else {
  ...
  return (
    <View style={styles.screenContainer}>
      ...
      <ImageBackground source={require('../../../assets/grayBg.jpg')} style={{ flex: 1 }}>
        ...
        <ImageBackground source={require('../../../assets/bgUpG.jpg')} style={styles.headerBg} imageStyle={styles.headerBgImage}>
