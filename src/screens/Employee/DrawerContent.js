    ...
    try {
      ...
      if (apiResponse.isAxiosError == true) {
        ...
        navigation.dispatch(
          CommonActions.reset({
            index: 0,
            routes: [{ name: Constants.screen.LoginScreen }],
          })
        );
  ...
  async function pause_Unpause_User() {
    ...
    try {
      ...
      if (apiResponse.isAxiosError == true) {
        ...
        Alert.alert(
          "Alert!",
          pause == "1" ? "Your account is paused" : "Your account is live"
        );
      }
    } catch (error) {
      console.log("Catch Body:", error);
    ...
    <>
      ...
      <View style={{ flex: 1 }}>
        ...
        <ScrollView style={{ marginLeft: 20, marginBottom: 15 }}>
          ...
          <IconButton
            title={LocalStrings.SavedJobs}
            style={styles.IconButtonContainer}
            onPress={() => navigation.navigate(Constants.screen.SavedJobs)}
          >
            <FontAwesome
              name="bookmark"
              size={30}
          ...
          <IconButton
            ...
            style={styles.IconButtonContainer}
            onPress={() =>
              navigation.navigate(Constants.screen.EmployeeProfile)
            }
          >
          ...
          <IconButton
            title={LocalStrings.ChangePassword}
            style={styles.IconButtonContainer}
            onPress={() => navigation.navigate(Constants.screen.ChangePassword)}
          >
            <Ionicons
              name="lock-closed"
              size={30}
          ...
          <IconButton
            title={LocalStrings.DeleteAccount}
          ...
          <IconButton
            title={
              pause == "1"
                ? LocalStrings.PauseAccount
                : LocalStrings.UnPauseAccount
            }
            style={styles.iconButton}
            onPress={() => {
              pause_Unpause_User();
