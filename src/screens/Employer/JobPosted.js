...
import { jobPostedSelector, jobsCategoryList, userLogin, setJobPost, setLanguageSelected } from '../../redux/slices';
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener('focus', () => {
      if ((job.jobTitle != '' || job.address != '' ||
        ...
        job.zipCode != '' || job.requiredLanguage != 0 || job.requiredExperience != 0
    ...
    style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
      ...
      <ImageBackground source={require('../../../assets/grayBg.jpg')} style={styles.bg}>
        ...
        <View style={styles.infoContainer}>
          ...
          <CustomPicker
            pickerTitleStyle={{ color: reqLang == 0 && missingField == true ? 'red' : colors.primaryColor }}
            pickerContainerStyle={{ marginTop: 10 }}
          ...
          >
            {
              jobLanguages.map((val, index) => (
                <Picker.Item style={{ fontSize: 14 }} key={index} label={val.value} value={val.value} />
              ))
            }
          </CustomPicker>

          <CustomPicker
            pickerTitleStyle={{ color: reqExp == 0 && missingField == true ? 'red' : colors.primaryColor }}
            pickerContainerStyle={{ marginTop: 10 }}
          ...
          >
            ...
            <Picker.Item label={'1 - 15'} value={'11'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 20'} value={'12'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 25'} value={'13'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 30'} value={'14'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 35'} value={'15'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 40'} value={'16'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 45'} value={'17'} style={{ fontSize: 14 }} />
            <Picker.Item label={'1 - 50'} value={'18'} style={{ fontSize: 14 }} />
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5, marginLeft: 7 }}>
            ...
            >
              <Text style={{ fontSize: 12, color: colors.buttonColor }}>{LocalStrings.ViewfullAddress}</Text>
            </TouchableOpacity>
