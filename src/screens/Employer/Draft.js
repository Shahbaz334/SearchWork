...
const Draft = ({ navigation }) => {
  ...
  const subCategoryItems = categoryList?.filter(
    (val) => val.category_id_decode == job.jobCategory
  )[0]?.subcategories;
  ...
  job.jobSubCategory != 0 &&
    bodyFormData.append("sub_category_id", job.jobSubCategory);
  ...
  job.noOfEmployees != 0 &&
    bodyFormData.append("no_of_posts", job.noOfEmployees);
      ...
      >
        ...
        <View style={styles.infoContainer}>
          <InputField
            textStyle={{
              color:
                job.jobTitle == "" && isFieldEmpty == true
                  ? "red"
                  : colors.primaryColor,
            }}
            title="Job Title"
          ...
          >
            <InputField
              textStyle={{
                color:
                  job.hourlyPay == "" && isFieldEmpty == true
                    ? "red"
                    : colors.primaryColor,
              }}
              style={{ flex: 0.45 }}
            ...
            <CustomPicker
              pickerTitleStyle={{
                color:
                  job.duration == 0 && isFieldEmpty == true
                    ? "red"
                    : colors.primaryColor,
              }}
          ...
          <CustomPicker
            pickerTitleStyle={{
              color:
                job.jobCategory == 0 && isFieldEmpty == true
                  ? "red"
                  : colors.primaryColor,
            }}
          ...
          <InputField
            textStyle={{
              color:
                job.jobDescription == "" && isFieldEmpty == true
                  ? "red"
                  : colors.primaryColor,
            }}
            title="Description"
          ...
          >
            <TouchableOpacity
              onPress={() =>
                Linking.openURL(
                  `${Constants.Map}${job.address}, ${job.state}, ${job.city}, ${job.zipCode}`
